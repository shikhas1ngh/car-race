...
intro_background=pygame.image.load("bg.jpg")
...
def intro_loop():
    ...
    while intro:
        ...
        button("QUIT",450,520,100,50,red,bright_red,"quit")
        button("HELP",300,520,100,50,white,cyan,"intro")
...
def introduction():
    ...
    while introduction:
        ...
        gamedisplays.blit(TextSurf,TextRect)
        gamedisplays.blit(textSurf,textRect)
        stextSurf,stextRect=text_objects("letter l : LEFT TURN",smalltext)
        stextRect.center=((150),(400))
        hTextSurf,hTextRect=text_objects("letter r : RIGHT TURN" ,smalltext)
        ...
        button("BACK",600,450,100,50,white,cyan,"menu")
        pygame.display.update()
        clock.tick(30)
...
def paused():
    ...
    while pause:
            ...
            button("RESTART",350,450,150,50,cyan,bright_blue,"play")
...
# ensure enemy car movement
        ...
        button("Pause",650,0,150,50,cyan,white,"pause")
